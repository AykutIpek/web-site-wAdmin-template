...
<body>
    ...
    $row = $cek -> fetch(PDO::FETCH_ASSOC);
        ...
        if(@$_POST["submit"]){
            ...
            $ekle=$db->prepare("UPDATE `blog` SET `baslik` = :baslik, `alt_baslik` = :alt_baslik, `aciklama` = :aciklama, `aktif` = :aktif WHERE `id` = :id");

            $ekle -> bindValue(":id", $id , PDO::PARAM_INT);
            ...
            if ($ekle->execute()) {
                ...
                header("Locaiton: blog.php?i=hata");
            }
        }
    ?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="aciklama" id="mytextarea"><?= htmlspecialchars_decode($row ["aciklama"]) ?></textarea>
                                        </div>  
                                        <div class="form-group">
                                            <label>Durum</label>
                                            <div class="radio">
                                        ...
                                        <input type="submit" class="btn btn-default" value="Kaydet" name="submit">
